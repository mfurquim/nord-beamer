...
% 		\shade[left color=NordBlack, right color=NordBG]
% 		% \shade[outer color=NordBG, inner color=NordMediumBlack]
...
\begin{frame}[noframenumbering]
	...
	\begin{center}
		...
		\end{mdframed}
		\vskip-32pt\hfill\resizebox{16px}{!}{\includegraphics{smallest_logo_transparent_bg.png}}\hskip4pt\null
	\end{center}
	\vfill\null
