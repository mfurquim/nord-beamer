...
\newminted{python}{texcomments=true,samepage=true,resetmargins=true,python3=true,tabsize=4,obeytabs=false,linenos=true,labelposition=all,label=Isso é uma label,highlightcolor=NordBrightBlack,highlightlines={1, 3-4},frame=lines,fontsize=\tiny,autogobble,breaklines,breaksymbolleft=\textcolor{NordBrightBlack}{\tiny$\hookrightarrow$}}
\begin{frame}[fragile=singleslide]
	...
	% \begin{minted}[bgcolor=NordBG,autogobble,breaklines,breaksymbolleft=\textcolor{NordBrightBlack}{\tiny$\hookrightarrow$}]{python}
	\begin{pythoncode}
import functools
