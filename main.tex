...
\begin{frame}[fragile=singleslide,noframenumbering,squeeze]
	...
	\begin{tikzpicture}[overlay,remember picture]
		\draw[help lines, NordBG] (0,0) grid (11,9);
		...
		\node [above] at (5.5,4.5) {\tiny{above}};
		\node [below] at (5.5,4.5) {\tiny{below}};
		\node [left] at (5.5,4.5) {\tiny{left}};
		\node [right] at (5.5,4.5) {\tiny{right}};

		\filldraw[NordBG] (5.5,7.5) circle (1pt);
		\node [below right] at (5.5,7.5) {\tiny{below right}};
		\node [below left] at (5.5,7.5) {\tiny{below left}};
		\node [above right] at (5.5,7.5) {\tiny{above right}};
		\node [above left] at (5.5,7.5) {\tiny{above left}};
	\end{tikzpicture}
